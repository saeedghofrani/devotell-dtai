...
export class Indexing1743516338265 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_2023ecff836fc0a3baf620ab45" ON "job_skills" ("skill") `);
        await queryRunner.query(`CREATE INDEX "IDX_764a76c5bc34d1ee2fc3122919" ON "jobs" ("position") `);
        await queryRunner.query(`CREATE INDEX "IDX_499a809ce235a6cd85285d4d69" ON "jobs" ("postedDate") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_499a809ce235a6cd85285d4d69"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_764a76c5bc34d1ee2fc3122919"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2023ecff836fc0a3baf620ab45"`);
