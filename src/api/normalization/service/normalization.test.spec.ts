...
describe('NormalizationService', () => {
  ...
  it('should correctly normalize a job with a remote location', () => {
    ...
    expect(
      service.normalizeSecondProvider('second-provider-123', secondProviderJob),
    ).toEqual(expectedNormalizedJob);
  });
  ...
  it('should throw error with a null salary range', () => {
    ...
    expect(() => service.normalizeFirstProvider(firstProviderJob)).toThrow(
      BadRequestException,
    );
  });
