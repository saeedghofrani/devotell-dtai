...
describe('DevotelService', () => {
    ...
    beforeEach(async () => {
        ...
        devotelConfigService = module.get<DevotelConfigService>(DevotelConfigService);
    });
    ...
    it('should handle network errors gracefully when fetching first provider jobs', async () => {
        ...
        jest.spyOn(requestService, 'get').mockRejectedValue(new Error(errorMessage));

        await expect(service.fetchFirstProviderJobs()).rejects.toThrow(errorMessage);
    ...
    it('should handle network errors gracefully when fetching second provider jobs', async () => {
        ...
        await expect(service.fetchSecondProviderJobs()).rejects.toThrow(errorMessage);
