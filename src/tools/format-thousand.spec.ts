...
describe('formatCompensation', () => {
    ...
    it('should throw an error when min is greater than max', () => {
        ...
        expect(() => formatCompensation(comp)).toThrow('Minimum value cannot be greater than maximum value');
    });
    ...
    it('should throw an error when currency is an empty string', () => {
        ...
        expect(() => formatCompensation(comp)).toThrow('Currency cannot be an empty string');
    });
